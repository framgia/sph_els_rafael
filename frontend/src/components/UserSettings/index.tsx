...
import UserPhotoSettings from './UserPhotoSettings';
    ...
    return (
        <div className={classes.settingsBox}>
            ...
            <div className="flex font-sans px-10 py-5 bg-gray-900">
                ...
                <NavLink activeClassName="font-bold" className="ml-5" to="/Settings/UserPhoto">Display Picture</NavLink>
            </div>
            <div>
                <Switch>
                    ...
                    <Route path="/Settings/UserPhoto" exact >
                        <UserPhotoSettings />
                    </Route>
